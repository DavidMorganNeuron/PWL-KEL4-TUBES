{{-- FOOTER --}}
<footer style="background: #1C0F0A; color: rgba(245,233,211,0.65); margin-top: auto; border-top: 1px solid rgba(245,233,211,0.07);">
    <div style="width: 1280px; margin: 0 auto; padding: 3.5rem 2.5rem 0;">

        {{-- GRID 3 KOLOM: brand | navigasi | jam operasional --}}
        <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 3rem;">
            ...
            <div style="max-width: 280px;">
                ...
                <div style="width: 32px; height: 2px; background: #C8813B; margin-top: 1.25rem;" aria-hidden="true"></div>
            </div>
            ...
            <nav aria-label="Navigasi footer" style="min-width: 140px;">
                ...
                <ul style="list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 0.625rem;" role="list">
                    <li>
                        <a href="{{ route('main') }}"
                           style="font-size: 0.875rem; color: rgba(245,233,211,0.6); text-decoration: none; transition: color 0.2s;"
